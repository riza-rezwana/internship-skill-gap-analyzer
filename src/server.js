...
const skillAnalyzerApp = require('../skill-analyzer/src/app');
///////
...
// Merged Project 1 routes: Internship & Skill Analyzer modules.
// Dashboard alias: /skill-analyzer
// Feature routes: /skill-gap, /matching, /skill-suggestions, /chatbot, and /api/...
app.use("/skill-analyzer", skillAnalyzerApp);
app.use("/", skillAnalyzerApp);
